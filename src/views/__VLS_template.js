import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name, data } from "./List.vue";
...
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_5, typeof __VLS_7> & Record<string, unknown>) => void)({ ...{}, class: ("card"), });
...
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_10, typeof __VLS_12> & Record<string, unknown>) => void)({ ...{}, class: ("card-header"), });
...
const __VLS_17 = __VLS_16({ ...{}, class: ("card-body"), }, ...__VLS_functionalComponentArgsRest(__VLS_16));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_15, typeof __VLS_17> & Record<string, unknown>) => void)({ ...{}, class: ("card-body"), });
const __VLS_18 = __VLS_pickFunctionalComponentCtx(__VLS_15, __VLS_17)!;
let __VLS_19!: __VLS_NormalizeEmits<typeof __VLS_18.emit>;
{
const __VLS_20 = __VLS_intrinsicElements["table"];
const __VLS_21 = __VLS_elementAsFunctionalComponent(__VLS_20);
const __VLS_22 = __VLS_21({ ...{}, class: ("table table-bordered"), }, ...__VLS_functionalComponentArgsRest(__VLS_21));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_20, typeof __VLS_22> & Record<string, unknown>) => void)({ ...{}, class: ("table table-bordered"), });
...
const __VLS_77 = __VLS_76({ ...{}, key: ((item.id)), }, ...__VLS_functionalComponentArgsRest(__VLS_76));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_75, typeof __VLS_77> & Record<string, unknown>) => void)({ ...{}, key: ((item.id)), });
...
{
const __VLS_115 = ({} as 'RouterLink' extends keyof typeof __VLS_ctx ? { 'RouterLink': typeof __VLS_ctx.RouterLink; } : typeof __VLS_resolvedLocalAndGlobalComponents).RouterLink;
const __VLS_116 = __VLS_asFunctionalComponent(__VLS_115, new __VLS_115({ ...{}, to: ("/"), class: ("btn btn-success"), }));
({} as { RouterLink: typeof __VLS_115; }).RouterLink;
({} as { RouterLink: typeof __VLS_115; }).RouterLink;
const __VLS_117 = __VLS_116({ ...{}, to: ("/"), class: ("btn btn-success"), }, ...__VLS_functionalComponentArgsRest(__VLS_116));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_115, typeof __VLS_117> & Record<string, unknown>) => void)({ ...{}, to: ("/"), class: ("btn btn-success"), });
...
const __VLS_122 = __VLS_121({ ...{}, type: ("button"), class: ("btn btn-danger"), }, ...__VLS_functionalComponentArgsRest(__VLS_121));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_120, typeof __VLS_122> & Record<string, unknown>) => void)({ ...{}, type: ("button"), class: ("btn btn-danger"), });
